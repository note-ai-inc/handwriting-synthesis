...
from model.tf_base_model import TFBaseModel
from model.rnn_ops import rnn_free_run
from model.rnn_cell import LSTMAttentionCell
from model.tf_utils import time_distributed_dense_layer, shape
...
################################################################################
def main():
    data_dir = "processedFiles"  # adapt to your location
